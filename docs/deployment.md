...
> Release 0.4.3 benötigt vor dem Rollout einen verifizierten Longhorn-VolumeSnapshot. Die
...
3. Den Git-Tag und Forgejo-Release `v0.4.3` erstellen und prüfen, dass
   `git.heerlab.com/beasty/qa-council:0.4.3` verfügbar ist.
