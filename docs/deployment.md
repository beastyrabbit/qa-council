...
> Release 0.3.1 benötigt vor dem Rollout einen verifizierten Longhorn-VolumeSnapshot. Die
...
3. Den Git-Tag und Forgejo-Release `v0.3.1` erstellen und prüfen, dass
   `git.heerlab.com/beasty/qa-council:0.3.1` verfügbar ist.
